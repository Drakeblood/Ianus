...
#include "Items/IanusItemSlot.h"
#include "Items/IanusItemData.h"
#include "IanusCharacterBase.generated.h"
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Abilities)
		TArray<TSubclassOf<UIanusGameplayAbility>> GameplayAbilities;

	/** Map of item slot to gameplay ability class, these are bound before any abilities added by the inventory */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Abilities)
		TMap<FIanusItemSlot, TSubclassOf<UIanusGameplayAbility>> DefaultSlottedAbilities;
	...
	UPROPERTY()
		UIanusAbilitySystemComponent* AbilitySystemComponent;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Inventory)
		TMap<FIanusItemSlot, FGameplayAbilitySpecHandle> SlottedAbilities;
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Abilities")
		bool ActivateAbilitiesWithItemSlot(FIanusItemSlot ItemSlot, bool bAllowRemoteActivation = true);

	/** Returns a list of active abilities bound to the item slot. This only returns if the ability is currently running */
	UFUNCTION(BlueprintCallable, Category = "Abilities")
		void GetActiveAbilitiesWithItemSlot(FIanusItemSlot ItemSlot, TArray<UIanusGameplayAbility*>& ActiveAbilities);
	...
	UFUNCTION(BlueprintCallable, Category = "Abilities")
		void GetActiveAbilitiesWithTags(FGameplayTagContainer AbilityTags, TArray<UIanusGameplayAbility*>& ActiveAbilities);
...
protected:
	...
	UFUNCTION(BlueprintImplementableEvent)
		void OnDamaged(float DamageAmount, const FHitResult& HitInfo, const struct FGameplayTagContainer& DamageTags, AIanusCharacterBase* InstigatorCharacter, AActor* DamageCauser);
	...
	void FillSlottedAbilitySpecs(TMap<FIanusItemSlot, FGameplayAbilitySpec>& SlottedAbilitySpecs);
	...
	// Called from IanusAttributeSet, these call BP events above
	virtual void HandleDamage(float DamageAmount, const FHitResult& HitInfo, const struct FGameplayTagContainer& DamageTags, AIanusCharacterBase* InstigatorCharacter, AActor* DamageCauser);
