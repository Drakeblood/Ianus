...
#include "IanusAbilityTypes.generated.h"

class UIanusAbilitySystemComponent;
class UGameplayEffect;
class UIanusTargetType;
...
struct FIanusGameplayEffectContainer
{
	GENERATED_BODY()

public:
	FIanusGameplayEffectContainer() {}

	/** Sets the way that targeting happens */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = GameplayEffectContainer)
	TSubclassOf<UIanusTargetType> TargetType;
...
USTRUCT(BlueprintType)
struct FIanusGameplayEffectContainerSpec
{
	GENERATED_BODY()

public:
	FIanusGameplayEffectContainerSpec() {}
