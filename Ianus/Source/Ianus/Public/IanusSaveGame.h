...
class IANUS_API UIanusSaveGame : public USaveGame
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = SaveGame)
		TMap<FPrimaryAssetId, FIanusItemData> InventoryData;

	/** Map of slotted items */
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = SaveGame)
		TMap<FIanusItemSlot, FPrimaryAssetId> SlottedItems;
